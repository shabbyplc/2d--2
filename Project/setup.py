...
startgame = Target(
    ...
    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="startgame", level="asInvoker")).encode("utf-8"))]
    )
...
resources = ['./resource/' + file_name for file_name in os.listdir('./resource/')]
